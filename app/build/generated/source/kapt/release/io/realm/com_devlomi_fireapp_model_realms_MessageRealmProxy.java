...
public class com_devlomi_fireapp_model_realms_MessageRealmProxy extends com.devlomi.fireapp.model.realms.Message
    implements RealmObjectProxy, com_devlomi_fireapp_model_realms_MessageRealmProxyInterface {
    ...
    private ProxyState<com.devlomi.fireapp.model.realms.Message> proxyState;

    com_devlomi_fireapp_model_realms_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.devlomi.fireapp.model.realms.Message>(this);
    ...
    public com.devlomi.fireapp.model.realms.RealmContact realmGet$contact() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.RealmContact.class, proxyState.getRow$realm().getLink(columnInfo.contactIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.devlomi.fireapp.model.realms.RealmLocation realmGet$location() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.RealmLocation.class, proxyState.getRow$realm().getLink(columnInfo.locationIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.devlomi.fireapp.model.realms.QuotedMessage realmGet$quotedMessage() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.QuotedMessage.class, proxyState.getRow$realm().getLink(columnInfo.quotedMessageIndex), false, Collections.<String>emptyList());
    }
    ...
    @SuppressWarnings("cast")
    public static com.devlomi.fireapp.model.realms.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.devlomi.fireapp.model.realms.Message obj = realm.createObjectInternal(com.devlomi.fireapp.model.realms.Message.class, true, excludeFields);

        final com_devlomi_fireapp_model_realms_MessageRealmProxyInterface objProxy = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) obj;
    ...
    public static com.devlomi.fireapp.model.realms.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.devlomi.fireapp.model.realms.Message obj = new com.devlomi.fireapp.model.realms.Message();
        final com_devlomi_fireapp_model_realms_MessageRealmProxyInterface objProxy = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_devlomi_fireapp_model_realms_MessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Message.class), false, Collections.<String>emptyList());
        io.realm.com_devlomi_fireapp_model_realms_MessageRealmProxy obj = new io.realm.com_devlomi_fireapp_model_realms_MessageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.devlomi.fireapp.model.realms.Message copyOrUpdate(Realm realm, MessageColumnInfo columnInfo, com.devlomi.fireapp.model.realms.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.devlomi.fireapp.model.realms.Message) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.devlomi.fireapp.model.realms.Message copy(Realm realm, MessageColumnInfo columnInfo, com.devlomi.fireapp.model.realms.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.devlomi.fireapp.model.realms.Message) cachedRealmObject;
        }

        com_devlomi_fireapp_model_realms_MessageRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) newObject;

        Table table = realm.getTable(com.devlomi.fireapp.model.realms.Message.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);

        // Add all non-"object reference" fields
        builder.addString(columnInfo.messageIdIndex, realmObjectSource.realmGet$messageId());
        builder.addString(columnInfo.fromIdIndex, realmObjectSource.realmGet$fromId());
        builder.addString(columnInfo.fromPhoneIndex, realmObjectSource.realmGet$fromPhone());
        builder.addString(columnInfo.toIdIndex, realmObjectSource.realmGet$toId());
        ...
        builder.addString(columnInfo.timestampIndex, realmObjectSource.realmGet$timestamp());
        builder.addString(columnInfo.chatIdIndex, realmObjectSource.realmGet$chatId());
        builder.addInteger(columnInfo.messageStatIndex, realmObjectSource.realmGet$messageStat());
        builder.addString(columnInfo.localPathIndex, realmObjectSource.realmGet$localPath());
        builder.addInteger(columnInfo.downloadUploadStatIndex, realmObjectSource.realmGet$downloadUploadStat());
        builder.addString(columnInfo.metadataIndex, realmObjectSource.realmGet$metadata());
        builder.addBoolean(columnInfo.voiceMessageSeenIndex, realmObjectSource.realmGet$voiceMessageSeen());
        builder.addString(columnInfo.mediaDurationIndex, realmObjectSource.realmGet$mediaDuration());
        builder.addString(columnInfo.thumbIndex, realmObjectSource.realmGet$thumb());
        builder.addBoolean(columnInfo.isForwardedIndex, realmObjectSource.realmGet$isForwarded());
        builder.addString(columnInfo.videoThumbIndex, realmObjectSource.realmGet$videoThumb());
        builder.addString(columnInfo.fileSizeIndex, realmObjectSource.realmGet$fileSize());
        builder.addBoolean(columnInfo.isGroupIndex, realmObjectSource.realmGet$isGroup());
        builder.addBoolean(columnInfo.isBroadcastIndex, realmObjectSource.realmGet$isBroadcast());
        builder.addBoolean(columnInfo.isSeenIndex, realmObjectSource.realmGet$isSeen());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_MessageRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        com.devlomi.fireapp.model.realms.RealmContact contactObj = realmObjectSource.realmGet$contact();
        if (contactObj == null) {
            ...
            if (cachecontact != null) {
                ...
                realmObjectCopy.realmSet$contact(com_devlomi_fireapp_model_realms_RealmContactRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_RealmContactRealmProxy.RealmContactColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.RealmContact.class), contactObj, update, cache, flags));
            }
        }

        com.devlomi.fireapp.model.realms.RealmLocation locationObj = realmObjectSource.realmGet$location();
        if (locationObj == null) {
            ...
            if (cachelocation != null) {
                ...
                realmObjectCopy.realmSet$location(com_devlomi_fireapp_model_realms_RealmLocationRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_RealmLocationRealmProxy.RealmLocationColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.RealmLocation.class), locationObj, update, cache, flags));
            }
        }

        com.devlomi.fireapp.model.realms.QuotedMessage quotedMessageObj = realmObjectSource.realmGet$quotedMessage();
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.devlomi.fireapp.model.realms.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Message.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$messageId = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$messageId();
        if (realmGet$messageId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.messageIdIndex, rowIndex, realmGet$messageId, false);
        }
        String realmGet$fromId = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$fromId();
        if (realmGet$fromId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fromIdIndex, rowIndex, realmGet$fromId, false);
        }
        String realmGet$fromPhone = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$fromPhone();
        ...
        String realmGet$toId = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$toId();
        if (realmGet$toId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.toIdIndex, rowIndex, realmGet$toId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$type(), false);
        String realmGet$content = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentIndex, rowIndex, realmGet$content, false);
        }
        String realmGet$timestamp = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampIndex, rowIndex, realmGet$timestamp, false);
        }
        String realmGet$chatId = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.messageStatIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$messageStat(), false);
        String realmGet$localPath = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$localPath();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.downloadUploadStatIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$downloadUploadStat(), false);
        String realmGet$metadata = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$metadata();
        if (realmGet$metadata != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.metadataIndex, rowIndex, realmGet$metadata, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.voiceMessageSeenIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$voiceMessageSeen(), false);
        String realmGet$mediaDuration = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$mediaDuration();
        ...
        String realmGet$thumb = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbIndex, rowIndex, realmGet$thumb, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isForwardedIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isForwarded(), false);
        String realmGet$videoThumb = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$videoThumb();
        ...
        String realmGet$fileSize = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$fileSize();
        if (realmGet$fileSize != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileSizeIndex, rowIndex, realmGet$fileSize, false);
        }

        com.devlomi.fireapp.model.realms.RealmContact contactObj = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$contact();
        if (contactObj != null) {
        ...
        com.devlomi.fireapp.model.realms.RealmLocation locationObj = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$location();
        if (locationObj != null) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isGroup(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenIndex, rowIndex, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isSeen(), false);

        com.devlomi.fireapp.model.realms.QuotedMessage quotedMessageObj = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$quotedMessage();
        if (quotedMessageObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Message.class);
        com.devlomi.fireapp.model.realms.Message object = null;
        while (objects.hasNext()) {
            object = (com.devlomi.fireapp.model.realms.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.devlomi.fireapp.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.devlomi.fireapp.model.realms.Message.class);
    ...
    public static com.devlomi.fireapp.model.realms.Message createDetachedCopy(com.devlomi.fireapp.model.realms.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.devlomi.fireapp.model.realms.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.devlomi.fireapp.model.realms.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.devlomi.fireapp.model.realms.Message) cachedObject.object;
            }
            unmanagedObject = (com.devlomi.fireapp.model.realms.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_devlomi_fireapp_model_realms_MessageRealmProxyInterface unmanagedCopy = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) unmanagedObject;
        com_devlomi_fireapp_model_realms_MessageRealmProxyInterface realmSource = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) realmObject;
