...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    static {
        ...
        modelClasses.add(com.devlomi.fireapp.model.TextStatus.class);
    ...
    public Map<Class<? extends RealmModel>, OsObjectSchemaInfo> getExpectedObjectSchemaInfoMap() {
        ...
        infoMap.put(com.devlomi.fireapp.model.TextStatus.class, io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.getExpectedObjectSchemaInfo());
        return infoMap;
    }
    ...
    public ColumnInfo createColumnInfo(Class<? extends RealmModel> clazz, OsSchemaInfo schemaInfo) {
        ...
        if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            return io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.createColumnInfo(schemaInfo);
        }
    ...
    public <E extends RealmModel> E newInstance(Class<E> clazz, Object baseRealm, Row row, ColumnInfo columnInfo, boolean acceptDefaultValue, List<String> excludeFields) {
        ...
        try {
            ...
            if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
                return clazz.cast(new io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy());
            }
            throw getMissingProxyClassException(clazz);
        } finally {
            objectContext.clear();
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E obj, boolean update, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            com_devlomi_fireapp_model_TextStatusRealmProxy.TextStatusColumnInfo columnInfo = (com_devlomi_fireapp_model_TextStatusRealmProxy.TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class);
            return clazz.cast(io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.copyOrUpdate(realm, columnInfo, (com.devlomi.fireapp.model.TextStatus) obj, update, cache, flags));
        }
        throw getMissingProxyClassException(clazz);
    }
    ...
    public void insert(Realm realm, RealmModel object, Map<RealmModel, Long> cache) {
        ...
        } else if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.insert(realm, (com.devlomi.fireapp.model.TextStatus) object, cache);
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
        ...
        if (iterator.hasNext()) {
            ...
            if (iterator.hasNext()) {
                if (clazz.equals(com.devlomi.fireapp.model.realms.Broadcast.class)) {
                    ...
                    io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.insert(realm, iterator, cache);
                } else {
                    throw getMissingProxyClassException(clazz);
                }
            }
    ...
    public void insertOrUpdate(Realm realm, RealmModel obj, Map<RealmModel, Long> cache) {
        ...
        if (clazz.equals(com.devlomi.fireapp.model.realms.Broadcast.class)) {
            ...
            io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.insertOrUpdate(realm, (com.devlomi.fireapp.model.TextStatus) obj, cache);
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
    ...
    public void insertOrUpdate(Realm realm, Collection<? extends RealmModel> objects) {
        ...
        if (iterator.hasNext()) {
            ...
            if (clazz.equals(com.devlomi.fireapp.model.realms.Broadcast.class)) {
                ...
                io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.insertOrUpdate(realm, (com.devlomi.fireapp.model.TextStatus) object, cache);
            } else {
                throw getMissingProxyClassException(clazz);
            }
            if (iterator.hasNext()) {
                if (clazz.equals(com.devlomi.fireapp.model.realms.Broadcast.class)) {
                    ...
                    io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.insertOrUpdate(realm, iterator, cache);
                } else {
                    throw getMissingProxyClassException(clazz);
                }
            }
    ...
    public <E extends RealmModel> E createOrUpdateUsingJsonObject(Class<E> clazz, Realm realm, JSONObject json, boolean update)
        ...
        if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            return clazz.cast(io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.createOrUpdateUsingJsonObject(realm, json, update));
        }
        throw getMissingProxyClassException(clazz);
    }
    ...
    public <E extends RealmModel> E createUsingJsonStream(Class<E> clazz, Realm realm, JsonReader reader)
        ...
        if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            return clazz.cast(io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.createUsingJsonStream(realm, reader));
        }
        throw getMissingProxyClassException(clazz);
    }
    ...
    public <E extends RealmModel> E createDetachedCopy(E realmObject, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        ...
        if (clazz.equals(com.devlomi.fireapp.model.TextStatus.class)) {
            return clazz.cast(io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy.createDetachedCopy((com.devlomi.fireapp.model.TextStatus) realmObject, 0, maxDepth, cache));
        }
        throw getMissingProxyClassException(clazz);
    }
