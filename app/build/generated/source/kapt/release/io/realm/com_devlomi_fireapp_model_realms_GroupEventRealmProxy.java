...
public class com_devlomi_fireapp_model_realms_GroupEventRealmProxy extends com.devlomi.fireapp.model.realms.GroupEvent
    ...
    private static com_devlomi_fireapp_model_realms_GroupEventRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.GroupEvent copy(Realm realm, GroupEventColumnInfo columnInfo, com.devlomi.fireapp.model.realms.GroupEvent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_GroupEventRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_GroupEventRealmProxyInterface) newObject;

        Table table = realm.getTable(com.devlomi.fireapp.model.realms.GroupEvent.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);

        // Add all non-"object reference" fields
        builder.addString(columnInfo.contextStartIndex, realmObjectSource.realmGet$contextStart());
        builder.addInteger(columnInfo.eventTypeIndex, realmObjectSource.realmGet$eventType());
        builder.addString(columnInfo.contextEndIndex, realmObjectSource.realmGet$contextEnd());
        builder.addString(columnInfo.timestampIndex, realmObjectSource.realmGet$timestamp());
        builder.addString(columnInfo.eventIdIndex, realmObjectSource.realmGet$eventId());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_GroupEventRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.GroupEvent object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.eventTypeIndex, rowIndex, ((com_devlomi_fireapp_model_realms_GroupEventRealmProxyInterface) object).realmGet$eventType(), false);
