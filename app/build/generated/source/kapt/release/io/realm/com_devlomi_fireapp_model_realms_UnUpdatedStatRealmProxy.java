...
public class com_devlomi_fireapp_model_realms_UnUpdatedStatRealmProxy extends com.devlomi.fireapp.model.realms.UnUpdatedStat
    ...
    public static com.devlomi.fireapp.model.realms.UnUpdatedStat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.UnUpdatedStat.class), false, Collections.<String> emptyList());
    ...
    private static com_devlomi_fireapp_model_realms_UnUpdatedStatRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.UnUpdatedStat copy(Realm realm, UnUpdatedStatColumnInfo columnInfo, com.devlomi.fireapp.model.realms.UnUpdatedStat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addInteger(columnInfo.statToBeUpdatedIndex, realmObjectSource.realmGet$statToBeUpdated());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_UnUpdatedStatRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.UnUpdatedStat object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.statToBeUpdatedIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UnUpdatedStatRealmProxyInterface) object).realmGet$statToBeUpdated(), false);
        return rowIndex;
    }
