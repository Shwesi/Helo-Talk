...
public class com_devlomi_fireapp_model_TextStatusRealmProxy extends com.devlomi.fireapp.model.TextStatus
    implements RealmObjectProxy, com_devlomi_fireapp_model_TextStatusRealmProxyInterface {
    ...
    private ProxyState<com.devlomi.fireapp.model.TextStatus> proxyState;

    com_devlomi_fireapp_model_TextStatusRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.devlomi.fireapp.model.TextStatus>(this);
    ...
    @SuppressWarnings("cast")
    public static com.devlomi.fireapp.model.TextStatus createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.devlomi.fireapp.model.TextStatus obj = null;
        if (update) {
            Table table = realm.getTable(com.devlomi.fireapp.model.TextStatus.class);
            TextStatusColumnInfo columnInfo = (TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("statusId")) {
                if (json.isNull("statusId")) {
                    obj = (io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy) realm.createObjectInternal(com.devlomi.fireapp.model.TextStatus.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy) realm.createObjectInternal(com.devlomi.fireapp.model.TextStatus.class, json.getString("statusId"), true, excludeFields);
                }
            } else {
        ...
        final com_devlomi_fireapp_model_TextStatusRealmProxyInterface objProxy = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) obj;
        if (json.has("text")) {
            if (json.isNull("text")) {
    ...
    public static com.devlomi.fireapp.model.TextStatus createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.devlomi.fireapp.model.TextStatus obj = new com.devlomi.fireapp.model.TextStatus();
        final com_devlomi_fireapp_model_TextStatusRealmProxyInterface objProxy = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_devlomi_fireapp_model_TextStatusRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class), false, Collections.<String>emptyList());
        io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy obj = new io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.devlomi.fireapp.model.TextStatus copyOrUpdate(Realm realm, TextStatusColumnInfo columnInfo, com.devlomi.fireapp.model.TextStatus object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.devlomi.fireapp.model.TextStatus) cachedRealmObject;
        }

        com.devlomi.fireapp.model.TextStatus realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.devlomi.fireapp.model.TextStatus.class);
            long pkColumnIndex = columnInfo.statusIdIndex;
            long rowIndex = table.findFirstString(pkColumnIndex, ((com_devlomi_fireapp_model_TextStatusRealmProxyInterface) object).realmGet$statusId());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy();
    ...
    public static com.devlomi.fireapp.model.TextStatus copy(Realm realm, TextStatusColumnInfo columnInfo, com.devlomi.fireapp.model.TextStatus newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.devlomi.fireapp.model.TextStatus) cachedRealmObject;
        }

        com_devlomi_fireapp_model_TextStatusRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) newObject;
        ...
        io.realm.com_devlomi_fireapp_model_TextStatusRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.devlomi.fireapp.model.TextStatus object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.statusIdIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_devlomi_fireapp_model_TextStatusRealmProxyInterface) object).realmGet$statusId();
        ...
        String realmGet$text = ((com_devlomi_fireapp_model_TextStatusRealmProxyInterface) object).realmGet$text();
        if (realmGet$text != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.textIndex, rowIndex, realmGet$text, false);
        }
        String realmGet$fontName = ((com_devlomi_fireapp_model_TextStatusRealmProxyInterface) object).realmGet$fontName();
        if (realmGet$fontName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fontNameIndex, rowIndex, realmGet$fontName, false);
        }
        String realmGet$backgroundColor = ((com_devlomi_fireapp_model_TextStatusRealmProxyInterface) object).realmGet$backgroundColor();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        TextStatusColumnInfo columnInfo = (TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class);
        long pkColumnIndex = columnInfo.statusIdIndex;
        com.devlomi.fireapp.model.TextStatus object = null;
        while (objects.hasNext()) {
            object = (com.devlomi.fireapp.model.TextStatus) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.devlomi.fireapp.model.TextStatus object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.devlomi.fireapp.model.TextStatus.class);
    ...
    public static com.devlomi.fireapp.model.TextStatus createDetachedCopy(com.devlomi.fireapp.model.TextStatus realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.devlomi.fireapp.model.TextStatus unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.devlomi.fireapp.model.TextStatus();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.devlomi.fireapp.model.TextStatus) cachedObject.object;
            }
            unmanagedObject = (com.devlomi.fireapp.model.TextStatus) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_devlomi_fireapp_model_TextStatusRealmProxyInterface unmanagedCopy = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) unmanagedObject;
        com_devlomi_fireapp_model_TextStatusRealmProxyInterface realmSource = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) realmObject;
    ...
    static com.devlomi.fireapp.model.TextStatus update(Realm realm, TextStatusColumnInfo columnInfo, com.devlomi.fireapp.model.TextStatus realmObject, com.devlomi.fireapp.model.TextStatus newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_devlomi_fireapp_model_TextStatusRealmProxyInterface realmObjectTarget = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) realmObject;
        com_devlomi_fireapp_model_TextStatusRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_TextStatusRealmProxyInterface) newObject;
        Table table = realm.getTable(com.devlomi.fireapp.model.TextStatus.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addString(columnInfo.statusIdIndex, realmObjectSource.realmGet$statusId());
    ...
    public boolean equals(Object o) {
        ...
        com_devlomi_fireapp_model_TextStatusRealmProxy aTextStatus = (com_devlomi_fireapp_model_TextStatusRealmProxy)o;
