...
public class com_devlomi_fireapp_model_realms_PendingGroupJobRealmProxy extends com.devlomi.fireapp.model.realms.PendingGroupJob
    ...
    public com.devlomi.fireapp.model.realms.GroupEvent realmGet$groupEvent() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.GroupEvent.class, proxyState.getRow$realm().getLink(columnInfo.groupEventIndex), false, Collections.<String>emptyList());
    }
    ...
    public static com.devlomi.fireapp.model.realms.PendingGroupJob createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.PendingGroupJob.class), false, Collections.<String> emptyList());
    ...
    private static com_devlomi_fireapp_model_realms_PendingGroupJobRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.PendingGroupJob copy(Realm realm, PendingGroupJobColumnInfo columnInfo, com.devlomi.fireapp.model.realms.PendingGroupJob newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        io.realm.com_devlomi_fireapp_model_realms_PendingGroupJobRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        ...
        if (groupEventObj == null) {
            ...
            if (cachegroupEvent != null) {
                ...
                realmObjectCopy.realmSet$groupEvent(com_devlomi_fireapp_model_realms_GroupEventRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_GroupEventRealmProxy.GroupEventColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.GroupEvent.class), groupEventObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.PendingGroupJob object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.typeIndex, rowIndex, ((com_devlomi_fireapp_model_realms_PendingGroupJobRealmProxyInterface) object).realmGet$type(), false);
