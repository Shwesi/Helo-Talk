...
public class com_devlomi_fireapp_model_realms_JobIdRealmProxy extends com.devlomi.fireapp.model.realms.JobId
    ...
    private static com_devlomi_fireapp_model_realms_JobIdRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.JobId copy(Realm realm, JobIdColumnInfo columnInfo, com.devlomi.fireapp.model.realms.JobId newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_JobIdRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_JobIdRealmProxyInterface) newObject;
        ...
        builder.addInteger(columnInfo.jobIdIndex, realmObjectSource.realmGet$jobId());
        builder.addBoolean(columnInfo.isVoiceMessageIndex, realmObjectSource.realmGet$isVoiceMessage());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_JobIdRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.JobId object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.jobIdIndex, rowIndex, ((com_devlomi_fireapp_model_realms_JobIdRealmProxyInterface) object).realmGet$jobId(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVoiceMessageIndex, rowIndex, ((com_devlomi_fireapp_model_realms_JobIdRealmProxyInterface) object).realmGet$isVoiceMessage(), false);
        return rowIndex;
    }
