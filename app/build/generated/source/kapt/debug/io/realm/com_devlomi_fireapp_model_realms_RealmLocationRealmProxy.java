...
public class com_devlomi_fireapp_model_realms_RealmLocationRealmProxy extends com.devlomi.fireapp.model.realms.RealmLocation
    ...
    private static com_devlomi_fireapp_model_realms_RealmLocationRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.RealmLocation copy(Realm realm, RealmLocationColumnInfo columnInfo, com.devlomi.fireapp.model.realms.RealmLocation newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_RealmLocationRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_RealmLocationRealmProxyInterface) newObject;
        ...
        io.realm.com_devlomi_fireapp_model_realms_RealmLocationRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.RealmLocation object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.latIndex, rowIndex, ((com_devlomi_fireapp_model_realms_RealmLocationRealmProxyInterface) object).realmGet$lat(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.lngIndex, rowIndex, ((com_devlomi_fireapp_model_realms_RealmLocationRealmProxyInterface) object).realmGet$lng(), false);
