...
public class com_devlomi_fireapp_model_realms_QuotedMessageRealmProxy extends com.devlomi.fireapp.model.realms.QuotedMessage
    ...
    private static com_devlomi_fireapp_model_realms_QuotedMessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.QuotedMessage copy(Realm realm, QuotedMessageColumnInfo columnInfo, com.devlomi.fireapp.model.realms.QuotedMessage newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_QuotedMessageRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_QuotedMessageRealmProxyInterface) newObject;
        ...
        io.realm.com_devlomi_fireapp_model_realms_QuotedMessageRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.QuotedMessage object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.typeIndex, rowIndex, ((com_devlomi_fireapp_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$type(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastIndex, rowIndex, ((com_devlomi_fireapp_model_realms_QuotedMessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        return rowIndex;
    }
