...
public class com_devlomi_fireapp_model_realms_StatusRealmProxy extends com.devlomi.fireapp.model.realms.Status
    ...
    @Override
    public com.devlomi.fireapp.model.TextStatus realmGet$textStatus() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.textStatusIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.TextStatus.class, proxyState.getRow$realm().getLink(columnInfo.textStatusIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$textStatus(com.devlomi.fireapp.model.TextStatus value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Status", 12, 0);
    ...
    public static com.devlomi.fireapp.model.realms.Status createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (json.has("textStatus")) {
            if (json.isNull("textStatus")) {
                ...
                com.devlomi.fireapp.model.TextStatus textStatusObj = com_devlomi_fireapp_model_TextStatusRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("textStatus"), update);
        ...
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.devlomi.fireapp.model.TextStatus textStatusObj = com_devlomi_fireapp_model_TextStatusRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$textStatus(textStatusObj);
                }
    ...
    public static com.devlomi.fireapp.model.realms.Status copy(Realm realm, StatusColumnInfo columnInfo, com.devlomi.fireapp.model.realms.Status newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com.devlomi.fireapp.model.TextStatus textStatusObj = realmObjectSource.realmGet$textStatus();
        if (textStatusObj == null) {
            realmObjectCopy.realmSet$textStatus(null);
        } else {
            com.devlomi.fireapp.model.TextStatus cachetextStatus = (com.devlomi.fireapp.model.TextStatus) cache.get(textStatusObj);
            if (cachetextStatus != null) {
                realmObjectCopy.realmSet$textStatus(cachetextStatus);
            } else {
                realmObjectCopy.realmSet$textStatus(com_devlomi_fireapp_model_TextStatusRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_TextStatusRealmProxy.TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class), textStatusObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.Status object, Map<RealmModel,Long> cache) {
        ...
        com.devlomi.fireapp.model.TextStatus textStatusObj = ((com_devlomi_fireapp_model_realms_StatusRealmProxyInterface) object).realmGet$textStatus();
        if (textStatusObj != null) {
            Long cachetextStatus = cache.get(textStatusObj);
            if (cachetextStatus == null) {
                cachetextStatus = com_devlomi_fireapp_model_TextStatusRealmProxy.insert(realm, textStatusObj, cache);
            }
    ...
    public static long insertOrUpdate(Realm realm, com.devlomi.fireapp.model.realms.Status object, Map<RealmModel,Long> cache) {
        ...
        if (textStatusObj != null) {
            Long cachetextStatus = cache.get(textStatusObj);
            if (cachetextStatus == null) {
                cachetextStatus = com_devlomi_fireapp_model_TextStatusRealmProxy.insertOrUpdate(realm, textStatusObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.textStatusIndex, rowIndex, cachetextStatus, false);
        } else {
    ...
    public static com.devlomi.fireapp.model.realms.Status createDetachedCopy(com.devlomi.fireapp.model.realms.Status realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        unmanagedCopy.realmSet$textStatus(com_devlomi_fireapp_model_TextStatusRealmProxy.createDetachedCopy(realmSource.realmGet$textStatus(), currentDepth + 1, maxDepth, cache));
    ...
    static com.devlomi.fireapp.model.realms.Status update(Realm realm, StatusColumnInfo columnInfo, com.devlomi.fireapp.model.realms.Status realmObject, com.devlomi.fireapp.model.realms.Status newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (textStatusObj == null) {
            ...
            if (cachetextStatus != null) {
                ...
                builder.addObject(columnInfo.textStatusIndex, com_devlomi_fireapp_model_TextStatusRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_TextStatusRealmProxy.TextStatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.TextStatus.class), textStatusObj, true, cache, flags));
            }
        }
        builder.addInteger(columnInfo.typeIndex, realmObjectSource.realmGet$type());
        builder.addInteger(columnInfo.durationIndex, realmObjectSource.realmGet$duration());
