...
public class com_devlomi_fireapp_model_realms_UserRealmProxy extends com.devlomi.fireapp.model.realms.User
    ...
    public com.devlomi.fireapp.model.realms.Group realmGet$group() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.Group.class, proxyState.getRow$realm().getLink(columnInfo.groupIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.devlomi.fireapp.model.realms.Broadcast realmGet$broadcast() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.Broadcast.class, proxyState.getRow$realm().getLink(columnInfo.broadcastIndex), false, Collections.<String>emptyList());
    }
    ...
    public static com.devlomi.fireapp.model.realms.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.User.class), false, Collections.<String> emptyList());
    ...
    private static com_devlomi_fireapp_model_realms_UserRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.User copy(Realm realm, UserColumnInfo columnInfo, com.devlomi.fireapp.model.realms.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addString(columnInfo.photoIndex, realmObjectSource.realmGet$photo());
        ...
        builder.addString(columnInfo.userLocalPhotoIndex, realmObjectSource.realmGet$userLocalPhoto());
        builder.addString(columnInfo.userNameIndex, realmObjectSource.realmGet$userName());
        builder.addBoolean(columnInfo.isBlockedIndex, realmObjectSource.realmGet$isBlocked());
        builder.addString(columnInfo.appVerIndex, realmObjectSource.realmGet$appVer());
        builder.addString(columnInfo.thumbImgIndex, realmObjectSource.realmGet$thumbImg());
        builder.addBoolean(columnInfo.isGroupBoolIndex, realmObjectSource.realmGet$isGroupBool());
        builder.addBoolean(columnInfo.isBroadcastBoolIndex, realmObjectSource.realmGet$isBroadcastBool());
        builder.addBoolean(columnInfo.isStoredInContactsIndex, realmObjectSource.realmGet$isStoredInContacts());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_UserRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        ...
        if (groupObj == null) {
            ...
            if (cachegroup != null) {
                ...
                realmObjectCopy.realmSet$group(com_devlomi_fireapp_model_realms_GroupRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_GroupRealmProxy.GroupColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Group.class), groupObj, update, cache, flags));
            }
        }
        ...
        if (broadcastObj == null) {
            ...
            if (cachebroadcast != null) {
                ...
                realmObjectCopy.realmSet$broadcast(com_devlomi_fireapp_model_realms_BroadcastRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_BroadcastRealmProxy.BroadcastColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Broadcast.class), broadcastObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.User object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBlockedIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UserRealmProxyInterface) object).realmGet$isBlocked(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupBoolIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UserRealmProxyInterface) object).realmGet$isGroupBool(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastBoolIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UserRealmProxyInterface) object).realmGet$isBroadcastBool(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isStoredInContactsIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UserRealmProxyInterface) object).realmGet$isStoredInContacts(), false);
        return rowIndex;
    }
    ...
    static com.devlomi.fireapp.model.realms.User update(Realm realm, UserColumnInfo columnInfo, com.devlomi.fireapp.model.realms.User realmObject, com.devlomi.fireapp.model.realms.User newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com.devlomi.fireapp.model.realms.Group groupObj = realmObjectSource.realmGet$group();
        if (groupObj == null) {
            builder.addNull(columnInfo.groupIndex);
        } else {
            com.devlomi.fireapp.model.realms.Group cachegroup = (com.devlomi.fireapp.model.realms.Group) cache.get(groupObj);
            if (cachegroup != null) {
                builder.addObject(columnInfo.groupIndex, cachegroup);
            } else {
                builder.addObject(columnInfo.groupIndex, com_devlomi_fireapp_model_realms_GroupRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_GroupRealmProxy.GroupColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Group.class), groupObj, true, cache, flags));
            }
        }

        com.devlomi.fireapp.model.realms.Broadcast broadcastObj = realmObjectSource.realmGet$broadcast();
        if (broadcastObj == null) {
            builder.addNull(columnInfo.broadcastIndex);
        } else {
            com.devlomi.fireapp.model.realms.Broadcast cachebroadcast = (com.devlomi.fireapp.model.realms.Broadcast) cache.get(broadcastObj);
            if (cachebroadcast != null) {
                builder.addObject(columnInfo.broadcastIndex, cachebroadcast);
            } else {
                builder.addObject(columnInfo.broadcastIndex, com_devlomi_fireapp_model_realms_BroadcastRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_BroadcastRealmProxy.BroadcastColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Broadcast.class), broadcastObj, true, cache, flags));
            }
        }
        builder.addBoolean(columnInfo.isBroadcastBoolIndex, realmObjectSource.realmGet$isBroadcastBool());
        builder.addBoolean(columnInfo.isStoredInContactsIndex, realmObjectSource.realmGet$isStoredInContacts());
