...
public class com_devlomi_fireapp_model_realms_PhoneNumberRealmProxy extends com.devlomi.fireapp.model.realms.PhoneNumber
    ...
    private static com_devlomi_fireapp_model_realms_PhoneNumberRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.PhoneNumber copy(Realm realm, PhoneNumberColumnInfo columnInfo, com.devlomi.fireapp.model.realms.PhoneNumber newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_PhoneNumberRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_PhoneNumberRealmProxyInterface) newObject;

        Table table = realm.getTable(com.devlomi.fireapp.model.realms.PhoneNumber.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);

        // Add all non-"object reference" fields
        builder.addString(columnInfo.numberIndex, realmObjectSource.realmGet$number());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_PhoneNumberRealmProxy realmObjectCopy = newProxyInstance(realm, row);
