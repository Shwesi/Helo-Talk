...
public class com_devlomi_fireapp_model_realms_UnUpdatedVoiceMessageStatRealmProxy extends com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat
    ...
    public static com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat.class), false, Collections.<String> emptyList());
    ...
    private static com_devlomi_fireapp_model_realms_UnUpdatedVoiceMessageStatRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat copy(Realm realm, UnUpdatedVoiceMessageStatColumnInfo columnInfo, com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addString(columnInfo.myUidIndex, realmObjectSource.realmGet$myUid());
        builder.addBoolean(columnInfo.isVoiceMessageSeenIndex, realmObjectSource.realmGet$isVoiceMessageSeen());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_UnUpdatedVoiceMessageStatRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.UnUpdatedVoiceMessageStat object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVoiceMessageSeenIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UnUpdatedVoiceMessageStatRealmProxyInterface) object).realmGet$isVoiceMessageSeen(), false);
        return rowIndex;
    }
